...
__all__ = ["WiderFace_DatasetMapper"]


class WiderFace_DatasetMapper:
    """
    ...
    def __init__(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            self.tfm_gens.append(T.RandomFlip(prob=0.5, horizontal=True, vertical=False))
            self.tfm_gens.append(T.RandomFlip(prob=0.5, horizontal=False, vertical=True))
